    ...
    <div class="jumbotron">
      ...
      <div class="container">
        <form novalidate autocomplete="off" @submit.prevent="enviar()">
          ...
          <!-- ------------ -->
          <div class="form-group">
            <input type="submit" :disabled="v.$invalid" class="btn btn-success mt-4" value="Enviar" />
          </div>
        </form>

        <div v-if="agregado" class="alert alert-warning">
          REGISTRO AGREGADO
        </div>
        <div v-if="agregado">
          <button class="btn btn-primary" @click="goProductos()">
            Volver
          </button>
        </div>
      </div>
